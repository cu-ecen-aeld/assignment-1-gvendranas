...
int Test_validate_username_main(void)
{
  UnityBegin("/home/yocto_machine/linux-trainings/linux-system-programming/assignment1/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
